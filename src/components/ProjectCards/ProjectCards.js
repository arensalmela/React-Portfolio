  ...
  return (
    <div>
      ...
      <div className="row pb-5">
        <div className="col">
          <div
            className="card shadow-lg p-3 mb-5 roundCorners"
            style={{ width: "18rem" }}
          >
            <img
              className="imgRound card-img-top"
              src={WeatherDB}
              alt="Card image cap"
            />
            <div className="card-body">
              ...
              <div className="row portfolioBtns">
                <a
                  href=" https://arensalmela.github.io/WeatherDashboard/"
                  target="_blank"
                ...
                <br />
                <a
                  href="https://github.com/arensalmela/WeatherDashboard"
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                  Github
        ...
        <div className="col">
          <div
            className="card shadow-lg p-3 roundCorners"
            style={{ width: "18rem" }}
          >
            <img
              className="imgRound card-img-top"
            ...
            <div className="card-body card-color">
              ...
              <div className="row portfolioBtns">
                <a
                  href=" https://arensalmela.github.io/TravelWebsite/"
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                  Website
                ...
                <br />
                <a
                  href="https://github.com/arensalmela/TravelWebsite"
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                  Github
      ...
      <div className="row">
        <div className="col">
          ...
          >
            ...
            <div className="card-body card-color">
              ...
              <div className="row portfolioBtns">
                <a
                  href=" https://arensalmela.github.io/WorkDayScheduler/
                "
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                ...
                <a
                  href="https://github.com/arensalmela/WorkDayScheduler"
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                  Github
        ...
        <div className="col">
          <div
            className="roundCorners shadow-lg p-3 card"
            style={{ width: "18rem" }}
          >
            <img
              className="imgRound card-img-top"
            ...
            <div className="card-body card-color">
              ...
              <div className="row portfolioBtns">
                <a
                  href=" https://arensalmela.github.io/PasswordGenerator/"
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                  Website
                ...
                <a
                  href="https://github.com/arensalmela/PasswordGenerator"
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                  GitHub
      ...
      <div className="row mb-5">
        <div className="col">
          <div
            className="card shadow-lg p-3 mt-5 roundCorners"
            style={{ width: "18rem" }}
          >
            <img
              className="imgRound card-img-top"
            ...
            <div className="card-body">
              ...
              <div className="row portfolioBtns">
                <a
                  href="https://hydro-homies.herokuapp.com/index.html
                  "
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                ...
                <br />
                <a
                  href="https://github.com/arensalmela/hydrohomies"
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                  Github
        ...
        <div className="col">
          <div
            className="card shadow-lg mt-5 p-3 roundCorners"
            style={{ width: "18rem" }}
          >
            <img
              className="imgRound card-img-top"
            ...
            <div className="card-body card-color">
              ...
              <div className="row portfolioBtns">
                <a
                  href="https://ads-notetaker.herokuapp.com/"
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                  Website
                ...
                <br />
                <a
                  href="https://github.com/arensalmela/NoteCreator"
                  target="_blank"
                  className="btn btn-outline-primary"
                >
                  Github
